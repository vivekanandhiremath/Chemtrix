...
@CucumberOptions(features = "src/test/resources/features/CreditDays_Limit.feature", glue = {
		"com.chemtrix.qa.stepdefinitions.creditDay_Limit", "com.chemtrix.qa.hooks" }, publish = true, plugin = {
				"pretty",
				"html:report/CreditLimitHTMLReports/CreditLimitMDApprove.html" }, tags = "@CreateCreditLimit or @BMSUBMITFORREVIEWCreditLimit or @CCMToMDCreditLimit or @MDAPPROVECreditLimit")
public class CreditLimitMdApprove {
//
}