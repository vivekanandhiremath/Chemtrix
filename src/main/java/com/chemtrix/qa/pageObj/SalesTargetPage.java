...
public class SalesTargetPage {

	WebDriver driver;
	private ElementUtils elementUtils;

	public SalesTargetPage(WebDriver driver) {
	...
	List<WebElement> existingqtyinmt;

	@FindBy(xpath = "//tbody//td[8]")
	List<WebElement> newqtyinmt;

	public void checkTheValidationFromPreviewPage() {

//

		elementUtils.comparingColumnsFromATable(existingqtyinmt, newqtyinmt, CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
	}
}
