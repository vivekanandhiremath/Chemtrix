...
@CucumberOptions(features = "src/test/resources/features/SalesOrder.feature", glue = {
		"com.chemtrix.qa.stepdefinitions.salesOrder", "com.chemtrix.qa.hooks" }, publish = true, plugin = { "pretty",
				"html:report/SalesOrderHTMLReports/SalesOrderTsmForceClosed.html" }, tags = "@CreateSalesOrderWithMandatory or @BMEnquiry or @TsmForceClosed", monochrome = false)
public class SalesOrderEnquiryForceClosedByTSM {
