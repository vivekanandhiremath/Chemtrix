...
@CucumberOptions(features = "src/test/resources/features/Prospect Entry.feature", glue = { "com.chemtrix.qa.stepdefinitions.prospectEntry",
		"com.chemtrix.qa.hooks" }, publish = true, plugin = { "pretty",
				"html:report/ProspectEntryHTMLReports/CreateProspectWithAllField.html",
				"json:report/ProspectEntryReports/CreateProspectWithAllField.json" }, tags = "@CreateProspectWithAllField")
public class ProspectEntry_CreateWithAll {
